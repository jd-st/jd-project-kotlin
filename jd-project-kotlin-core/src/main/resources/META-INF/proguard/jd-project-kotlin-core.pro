...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.jd_project.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.jd_project.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.jd_project.api.** {
    <init>(...);
