...
dependencies {
    testImplementation(project(":jd-project-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../jd-project-kotlin-core/src/main/resources/META-INF/proguard/jd-project-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../jd-project-kotlin-core/src/main/resources/META-INF/proguard/jd-project-kotlin-core.pro",
